import java.util.*;
/**
 * Write a description of class AccountTypeComp here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class AccountTypeComp implements Comparator<BankAccount>
   ...
   public int compare( BankAccount b1, BankAccount b2)
    {
        ...
        else if( !(b1 instanceof SavingsAccount) && b2 instanceof SavingsAccount)
        {
            return 1;
        }
        else
